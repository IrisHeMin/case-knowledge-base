---
layout: default
title: "Deep Dive: DNS & SMB"
permalink: /deep-dive/protocols/
---

<h2>📡 DNS & SMB</h2>
<p class="page-description">DNS server architecture, scavenging mechanisms, and SMB protocol internals.</p>
...
<ul class="post-list">
  {% for post in site.posts %}
    {% if post.path contains "deep-dive/" %}
      {% if post.path contains "dns-" or post.path contains "smb-" %}
